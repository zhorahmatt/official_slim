...
@section('title', 'URL Linked Create')
	
@section('contents')
	<div class="bg-light lter b-b wrapper-md">
		<h1 class="m-n font-thin h3">New Linked URL</h1>
	...
	<div class="wrapper-md">
		...
		<div class="panel">
			<div class="panel-body">
				<form action="{{ route('tautan_store') }}" method="post" enctype="multipart/form-data">
					{{ csrf_field() }}
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<input type="text" name="title" class="form-control input-lg" placeholder="URL title" value="{!! old('title') !!}">
							</div>
							
							<div class="form-group">
								<textarea name="description" class="form-control input-lg" placeholder="URL Description"></textarea>
							</div>

                            <div class="form-group">
								<textarea name="url_linked" class="form-control input-lg" placeholder="URL Linked"></textarea>
							</div>
						</div>
					</div>
