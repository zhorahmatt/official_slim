        ...
        <ul class="nav navbar-nav">
            ...
            <ul class="dropdown-menu">
                ...
                <ul class="menu">
                    ...
                    <a href="#">
                        <div class="pull-left">
                        <img src="{{ url('assets/adminlte') }}/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                        </div>
                        <h4>
                    ...
                    <a href="#">
                        <div class="pull-left">
                        <img src="{{ url('assets/adminlte') }}/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                        </div>
                        <h4>
                        Developers
