                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            ...
                            <tr>
                                <td style="padding: 0 40px 40px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
                                    <p style="margin: 0;">Anda terdaftar sebagai peserta dengan nomor registrasi :</p>
                                    <br>
                                    <h2 align="center">{{ $nomorRegistrasi }}</h2>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 0 40px 40px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
                                    ...
                                    <p>Contoh : Nomor registrasi 008, maka yang harus ditransfer sebesar Rp. 300.008,-</p>
                                    
                                    <p>Pembayaran melalui transfer ke :</p>
                                    <p align="center">
                                        <strong>BANK BCA<br>0251650585<br>ATAS NAMA RAHMAD HADI NUGROHO</strong>
                                    </p>
                                </td>
                            </tr>
                            <tr>
            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 680px; font-family: sans-serif; color: #888888; font-size: 12px; line-height: 140%;">
                <tr>
                    <td style="padding: 40px 10px; width: 100%; font-family: sans-serif; font-size: 12px; line-height: 140%; text-align: center; color: #888888;" class="x-gmail-data-detectors">
                        <br><br>
                        Jamselinas 8 Makassar - Sepeda Lipat Makassar<br>Jalan. AP Pettarani No. 3 Makassar <br>0821943739532
                        <br><br>
                    </td>
                </tr>
            </table>
