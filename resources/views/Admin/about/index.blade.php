				...
				<div class="panel-body">
							...
							<div class="row">
								<div class="col-md-4 col-sm-6">
									<div class="form-group">
										...
										@if ($about->image != '')
											<img src="{{ url('resources/uploaded').'/thumb-'.$about->image }}" width="100%">
										@endif
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="avatar thumb-xs m-r-xs" style="background: url({{ url('resources/uploaded') }}/thumb-{{ $team->image }}) center no-repeat; background-size: cover; width: 34px; height: 34px; vertical-align: middle"></div>
							@endforeach
